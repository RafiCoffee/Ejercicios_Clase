package com.example.ejercicios_clase.data.ui.viewModel
...
import com.example.ejercicios_clase.data.dao.DaoVideojuegos
...
class VideojuegosViewModel @Inject constructor(val contexto: Context, val videojuegosBinding: VideojuegosActivityBinding
    ...
    fun crearVideojuego(){
        mostrarCrearDialogo(object: com.example.ejercicios_clase.data.dialoges.DialogCallback {
    ...
    private fun actualizarVideojuego(pos: Int) {
        ...
        mostrarActualizarDialogo(videojuegoSeleccionado, object:
            com.example.ejercicios_clase.data.dialoges.DialogCallback {
            override fun onDialogResult(newVideojuego: Array<String>, isCanceled: Boolean){
                if(!isCanceled){
    ...
    private fun elegirFecha(){
        mostrarCalendario(object:
            com.example.ejercicios_clase.data.dialoges.DialogCallbackCalendario {
    ...
    private fun mostrarActualizarDialogo(videojuegoSeleccionado: Videojuego, callback: com.example.ejercicios_clase.data.dialoges.DialogCallback){
    ...
    private fun mostrarCrearDialogo(callback: com.example.ejercicios_clase.data.dialoges.DialogCallback){
        val newVideojuego = Array(5){""}
    ...
    private fun mostrarCalendario(callback: com.example.ejercicios_clase.data.dialoges.DialogCallbackCalendario) {
